    ...
    <>
      ...
      <div className="flex h-screen w-screen select-none items-center justify-center px-2">
        ...
        <motion.div
          ...
          className="z-10 w-full max-w-[478px] rounded bg-dark p-8 text-white shadow-xl"
        >
                ...
                <form onSubmit={handleSubmit} className="mt-5 w-full">
                  ...
                  >
                    ...
                    <p>
                      ...
                      updates, tips and special offers. You can opt out at any
                      time.
                    </p>
                  </div>
                  <button
                  ...
                  <p className="text-xs text-d-gray">
                    ...
                    <Link href="/" className="text-d-blue hover:underline">
                      Terms of Service
                    </Link>{" "}
                    and{" "}
                    <Link href="/" className="text-d-blue hover:underline">
